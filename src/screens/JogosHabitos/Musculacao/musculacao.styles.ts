// Importa o módulo de estilização e o tipo de interface.
...
export const styles = StyleSheet.create({
  ...
  iconHeader: { width: 80, height: 80, marginBottom: 15 },
  // Título em destaque.
  ...
  progressContainer: { width: '100%', marginTop: 25 },
  ...
  progressValue: { fontSize: 14, fontWeight: 'bold', color: colors.primary },
  ...
  sectionCard: { backgroundColor: colors.white, borderRadius: 20, padding: 20, marginBottom: 20 },
  sectionTitle: { fontSize: 16, fontWeight: 'bold', color: colors.textDark, marginBottom: 15 },
  // Organiza os chips um ao lado do outro com quebra de linha.
  ...
  gridButtons: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' },
  ...
  actionButtonText: { fontSize: 16, fontWeight: 'bold', color: colors.textDark },

  // Botão de reset no final da tela.
  resetButton: { marginTop: 10, marginBottom: 20, alignItems: 'center' },
